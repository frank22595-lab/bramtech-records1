...
import { ArrowLeft, LayoutDashboard, ClipboardList, Star, FileText, Users, Settings, Archive } from 'lucide-react'
...
export default function TermWorkspace() {
  ...
  const TABS = [
    ...
    { id: 'scores',   label: 'Result entry',       icon: ClipboardList },   // renamed
